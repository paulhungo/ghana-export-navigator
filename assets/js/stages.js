/* Ghana Agricultural Export Navigator — pathways & stage-card templates */
window.GEN_PATHWAYS = {
  fresh_plant: {
  ...
  fish: {
    ...
    intro: "Fish is a distinct pathway. GSA Fish Inspection registers exporters and approves establishments — for EU-oriented exports the FACILITY itself must be approved, not just the fish.",
    ...
    chainNote: "GSA registers fish exporters, inspects vessels, processing plants, cold stores, ice plants and consignments — and is Ghana's EU Competent Authority for fish products."
  },
  tree_crop: {
    label: "Tree crops (TCDA-regulated)",
    intro: "🔴 Your crop is regulated by the Tree Crops Development Authority. Since 1 April 2026 you MUST hold a valid written TCDA permit before exporting — processed or unprocessed.",
    ...
    chainNote: "TCDA regulates cashew, shea, mango, coconut, rubber and oil palm. Registration/licensing per crop + export permit. Accra: Tsatse Dzani St, Adjiringanor, GD-253-5536 · 030 398 1790 · info@tcda.gov.gh"
  },
  cocoa: {
    label: "Cocoa",
    intro: "Cocoa follows the COCOBOD system — a separate regulated sector with its own licensing and quality rules.",
    ...
    chainNote: "Confirm current COCOBOD licensing and quality requirements directly — cocoa has its own rules."
  },
  special: {
...
window.GEN_STAGE_TEMPLATES = {
  "stage-business": {
    ...
    analogy: "Think of it as a birth certificate for your business — without it, nothing else can happen.",
    ...
    pitfalls: ["Name rejected (too similar to an existing business) — have alternatives ready", "Wrong business type chosen for your plans", "Missing witnesses/subscribers for company registration"],
    next: "Stage 2 — Get your tax identification (TIN) at GRA."
  },
  "stage-tax": {
    ...
    analogy: "Your TIN is how government recognises you in every money matter — you will reuse it everywhere.",
    carry: "gra.whatToBring", steps: [
      "If you are an individual: your Ghana Card PIN is your TIN — keep it handy.",
    ...
    next: "Stage 3 — Register as an exporter with GEPA."
  },
  "stage-gepa": {
    ...
    analogy: "GEPA is your official gateway into the export world — registration says 'this business is an exporter.'",
    carry: "gepa.whatToBring", steps: [
      ...
      "Note: registration is renewable annually — diarise the renewal."
    ],
    ...
    pitfalls: ["Registration lapses after a year — set a renewal reminder", "Processing takes time when premises inspection is required — start early"],
    next: "Stage 4 — Register as a shipper with the Ghana Shippers' Authority."
  },
  "stage-gsa-shipper": {
    ...
    analogy: "This is your 'player's licence' for shipping — no shipper registration, no smooth shipping.",
    ...
    pitfalls: ["Waiting until the week of shipment — register before you have cargo ready"],
    next: "Stage 5 — Your product regulator."
  },
  "stage-pprsd": {
    n: 5, title: "Plant-health pathway (PPRSD)", agencyId: "pprsd", role: "Quality person",
    plain: "PPRSD is Ghana's National Plant Protection Organization. For fresh plant products, PPRSD inspects and issues the phytosanitary certificate — the plant-health passport of your consignment.",
    analogy: "Just as a person needs a clean health report to travel, your plants need one too — issued after inspection.",
    carry: "pprsd.whatToBring", steps: [
      ...
      "Collect the phytosanitary certificate before shipment — it must accompany the consignment."
    ],
    youGet: "Phytosanitary certificate (per consignment)",
    check: ["Certificate details match invoice and packing list exactly"],
    pitfalls: ["Booking inspection too late — certificates take time; inspect before packing if possible", "Destination-specific requirements not communicated — always tell PPRSD the destination country"],
    next: "Stage 6 — FDA export/clearance permit."
  },
  "stage-fda-fresh": {
    ...
    analogy: "FDA checks that what leaves Ghana is safe and traceable — the permit is the departure stamp for food.",
    ...
    pitfalls: ["🟡 Non-compliant consignments can be detained, corrected or destroyed at the exporter's cost — never skip inspection", "Expired storage licence"],
    next: "Stage 7 — Packaging compliance."
  },
  "stage-fda-processed": {
    ...
    analogy: "A processed food product must prove WHO made it, WHAT is inside, and WHEN it expires — before it travels.",
    carry: "fda.whatToBring", steps: [
    ...
    next: "Stage 6 — GSA standards (where applicable)."
  },
  "stage-gsa-optional": {
    n: 6, title: "GSA standards & testing (only if applicable)", agencyId: "gsa", role: "Quality person",
    plain: "GSA handles standards, testing, inspection and certification — but NOT every product needs GSA certification. It depends on the product, destination and buyer requirements.",
    ...
    pitfalls: ["Paying for certification you did not need — check first", "Testing the wrong batch"],
    next: "Stage 7 — Packaging compliance."
  },
  "stage-vsd": {
    ...
    analogy: "Animals travel with a medical passport — VSD issues it after checking health and vaccinations.",
    ...
    pitfalls: ["Destination refuses origins without approved establishments — confirm eligibility BEFORE investing", "Expired vaccination records"],
    next: "Stage 6 — Destination import permit."
  },
  "stage-dest-permit": {
  ...
  "stage-gsa-fish": {
    ...
    plain: "GSA Fish Inspection registers exporters of fish and fishery products, inspects and approves fishing vessels, processing plants, cold stores, ice-making plants and landing sites, inspects consignments — and is Ghana's EU Competent Authority for fish products.",
    ...
    carry: "gsa.whatToBring", steps: [
      ...
      "Implement food-safety systems (HACCP) and full traceability — catch to pack.",
    ...
    next: "Stage 6 — FDA clearance & destination requirements."
  },
  "stage-tcda": {
    n: 5, title: "TCDA registration & licensing", agencyId: "tcda", role: "Owner",
    plain: "The Tree Crops Development Authority regulates cashew, shea, mango, coconut, rubber and oil palm. Registration requirements can include business incorporation/commencement documents, business location, directors/shareholders, identification, TIN — and exporters face category-specific requirements such as export/warehousing capacity.",
    analogy: "TCDA is the landlord of the six tree crops — you must be registered with the landlord before you can trade his crops.",
    carry: "tcda.whatToBring", steps: [
      "Register with TCDA for your crop category (Accra: Tsatse Dzani St, Adjiringanor · Kumasi office available).",
    ...
    pitfalls: ["Assuming only fresh crops need TCDA — the 2026 permit rule covers processed forms too"],
    next: "Stage 6 — TCDA export permit."
  },
  "stage-tcda-permit": {
    n: 6, title: "TCDA export permit (mandatory since 1 Apr 2026)", agencyId: "tcda", role: "Owner",
    plain: "🔴 From 1 April 2026, exporting cashew, coconut, oil palm, rubber, mango or shea — processed OR unprocessed — requires a valid written TCDA permit. Apply on the Permit Application page; verify permits on the Permit Verification page.",
    analogy: "Think of the permit as a visa for the crop — no permit, no travel, no exceptions.",
    carry: "tcda.whatToBring", steps: [
    ...
    pitfalls: ["Shipping without the permit — consignments can be stopped", "Missing the 1 April 2026 rule change for processed forms"],
    next: "Stage 7 — Packaging compliance."
  },
  "stage-cocobod": {
  ...
  "stage-confirm-special": {
    ...
    steps: [
      ...
      "Call or visit the agency — contacts are on the Offices & Agencies page — and get the requirement in writing where possible."
    ],
  ...
  "stage-packaging": {
    ...
    analogy: "Your box talks for you at every inspection — if it cannot speak (labels), your goods stay behind.",
    steps: [
    ...
    check: ["Every required element is printed and legible", "Net weight accurate — verify by sampling"],
    pitfalls: ["Hand-written or missing batch numbers", "Ignoring destination-language label rules"],
    next: "Stage 8 — Buyer contract & readiness."
  },
  "stage-buyer": {
    ...
    steps: [
      ...
      "Complete the Export Readiness Score (Tools page) — fix the red items first.",
    ...
    next: "Stage 9 — Freight forwarder & clearing agent."
  },
  "stage-freight": {
    ...
    analogy: "These are your travel agents for goods — choose them the way you would choose a surgeon: verified, experienced, quoted in writing.",
    steps: [
      ...
      "🛡️ Pay only company accounts you have verified."
    ],
    ...
    next: "Stage 10 — Consignment certificates & customs."
  },
  "stage-certificates": {
    n: 10, title: "Consignment certificates & customs declaration", agencyId: "gra", role: "Treasurer",
    plain: "Per consignment: obtain the regulator certificates (phytosanitary/veterinary/health per product), FDA clearance, certificate of origin where applicable — then your agent lodges the export declaration in ICUMS with all documents attached.",
    analogy: "This is the exam day: every document is an answer sheet — one missing paper and the whole class (consignment) waits.",
    carry: "gra.whatToBring", steps: [
      ...
      "For traditional exports, obtain the Bank of Ghana Exchange Control Form A2 from your bankers (per GRA's export procedures)."
    ],
    ...
    next: "Stage 11 — Port/airport & shipment."
  },
  "stage-port": {
    ...
    analogy: "Your goods board their flight/ship — your paperwork has already gone ahead of them.",
    steps: [
    ...
    next: "Stage 12 — Arrival at destination."
  },
  "stage-arrival": {
    ...
    analogy: "The second half of the journey happens in your buyer's country — your contract decides who carries which burden.",
    steps: [
    ...
    next: "Stage 13 — Payment & banking."
  },
  "stage-payment": {
    n: 13, title: "Payment & export proceeds", agencyId: "bog", role: "Treasurer",
    plain: "The buyer pays according to your contract. Ghana's Bank of Ghana rules on repatriation of export proceeds apply — payments must be processed properly through banks.",
    ...
    steps: [
      ...
      "Complete any Bank of Ghana foreign-exchange documentation (Form A2 for traditional exports; Letter of Commitment per customs guidance).",
    ...
    pitfalls: ["Open account with an unknown buyer", "Informal payment channels — regulatory and fraud risk"],
    next: "Stage 14 — Keep your records; plan the next shipment."
  },
  "stage-records": {
    ...
    analogy: "Your export file is the memory of the business — businesses without memory repeat their mistakes.",
    steps: [
      ...
      "Review costs versus the calculator estimate — update your numbers.",
    ...
    pitfalls: ["Losing documents — scan and back up everything"],
